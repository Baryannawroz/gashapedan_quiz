<x-app-layout>
    ...
    <div class="">
        <div class="relative mr-4">
            <form action="resultSearch" method="GET">
                ...
                <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                    <svg class="h-6 w-6 lg:w-1/3 sm:w-full  text-gray-500" fill="none" stroke-linecap="round"
        ...
        <button onclick="exportTableToExcel('result-table', 'results')"
            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"> Excel</button>
    </div>
    @endif
        ...
        <div class="overflow-x-auto ">
            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                <div class="overflow-hidden">
                    <table id='result-table' class="min-w-full text-left text-sm font-light">
    ...
    <script>
        ...
        // Select the table element using the table ID
        
        var table = document.getElementById(tableId);
        
        // Create a workbook object using SheetJS
